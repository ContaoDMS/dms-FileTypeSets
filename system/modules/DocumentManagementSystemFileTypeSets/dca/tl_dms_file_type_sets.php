...
class tl_dms_file_type_sets extends Backend
{
	...
	public function addIcon($row, $label, DataContainer $dc, $args)
	{
		...
		$args[0] = sprintf('<div class="list_icon_new" style="background-image:url(\'system/modules/DocumentManagementSystemFileTypeSets/assets/%s\'); height: 16px;" data-icon="system/modules/DocumentManagementSystemFileTypeSets/assets/%s" data-icon-disabled="system/modules/DocumentManagementSystemFileTypeSets/assets/%s">&nbsp;</div>', $image);
